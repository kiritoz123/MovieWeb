<div class="containerss">
    <h2 class="mt-4 mb-4">Thêm Đạo Diễn Mới</h2>
    <form action="index.php?action=quanlydaodien&query=xuly" method="post" enctype="multipart/form-data" class="phim-form">
        <!-- Tên đạo diễn -->
        <div class="form-group">
            <label for="ten_dao_dien">Tên đạo diễn:</label>
            <input type="text" class="form-control" name="ten_dao_dien" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="file"  name="daodien_avatar" accept="image/*" required>
        </div>

        <button type="submit" class="btn-btn-primary" name="themdaodien">Thêm Đạo Diễn</button>
    </form>
</div>
<style>
    body {
